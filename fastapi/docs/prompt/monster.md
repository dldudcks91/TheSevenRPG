...
**Wolf — 약 (Lv1)**
```
pixel art, small dark wolf, lean hungry silhouette, matted gray fur,
glowing pale yellow eyes, crouched low ready to sprint, scarred muzzle,
color palette: dark gray, charcoal, pale yellow eyes, 16-bit style,
RPG monster sprite, black background, front-facing, full body
```

**Wolf — 중 (Lv2)**
```
pixel art, mid-sized dark wolf, muscular build, sleek black-gray fur,
bright amber eyes, battle-scarred body, sharp fangs visible, aggressive stance,
color palette: dark gray, black, amber, 16-bit style,
RPG monster sprite, black background, front-facing, full body
```

**Wolf — 강 (Lv3)**
```
pixel art, large alpha wolf, massive imposing frame, dark fur with red-tinged markings,
...
16-bit style, RPG monster sprite, black background, front-facing, full body
```
...
**Yeti — 약 (Lv1)**
```
pixel art, small yeti, hunched posture, dirty matted white-gray fur,
small sunken dark eyes, ragged and thin, worn primitive appearance,
color palette: dirty white, ash gray, dark brown, 16-bit style,
RPG monster sprite, black background, front-facing, full body
```

**Yeti — 중 (Lv2)**
```
pixel art, large yeti, broad muscular build, thick shaggy gray-white fur,
...
**Yeti — 강 (Lv3)**
```
pixel art, massive elite yeti, enormous hulking frame, dark gray fur with icy blue sheen,
...
**Troll — 약 (Lv1)**
```
pixel art, small troll, hunched lumpy body, warty greenish-gray skin,
...
**Troll — 중 (Lv2)**
```
pixel art, large troll, heavily built thick body, rough stone-like dark green skin,
...
**Troll — 강 (Lv3)**
```
pixel art, enormous elite troll, mountain-like body covered in natural rock plating,
...
**Lizardman — 약 (Lv1)**
```
pixel art, small lizardman, lean reptilian humanoid, dull dark green scales,
...
**Lizardman — 중 (Lv2)**
```
pixel art, lizardman warrior-shaman, medium build, dark teal scaly skin,
...
**Lizardman — 강 (Lv3)**
```
pixel art, elite lizardman warlord, powerful armored build, deep dark blue-green scales,
...
**Golem — 약 (Lv1)**
```
pixel art, small crumbling stone golem, crude lumpy shape, cracked gray stone body,
...
**Golem — 중 (Lv2)**
```
pixel art, stone golem, solid rectangular body of dark stone blocks,
...
**Golem — 강 (Lv3)**
```
pixel art, massive fortress golem, enormous body of dark iron-reinforced stone,
...
**Imp — 약 (Lv1)**
```
pixel art, tiny imp, small winged demon, scrawny red-dark skin, oversized head,
...
**Imp — 중 (Lv2)**
```
pixel art, imp caster, small winged demon hovering, dark crimson skin,
...
**Imp — 강 (Lv3)**
```
pixel art, elite imp sorcerer, small but radiating dark power, black-crimson skin,
...
**Goblin — 약 (Lv1)**
```
pixel art, small goblin, scrawny hunched figure, dull sickly green skin,
...
**Goblin — 중 (Lv2)**
```
pixel art, goblin raider, lean cunning build, dark green skin, wearing patchwork leather armor,
...
**Goblin — 강 (Lv3)**
```
pixel art, goblin warchief, stocky commanding figure, deep olive green skin,
...
**Succubus — 약 (Lv1)**
```
pixel art, lesser succubus, slender demonic female figure, pale ashen skin,
...
**Succubus — 중 (Lv2)**
```
pixel art, succubus enchantress, alluring but sinister demonic figure,
...
**Succubus — 강 (Lv3)**
```
pixel art, elite succubus queen, commanding dark demonic figure,
...
**Gargoyle — 약 (Lv1)**
```
pixel art, small gargoyle, crouched stone-like winged creature, rough gray stone skin,
...
**Gargoyle — 중 (Lv2)**
```
pixel art, gargoyle sentinel, medium build stone demon, dark granite skin texture,
...
**Gargoyle — 강 (Lv3)**
```
pixel art, elite gargoyle fortress, massive stone demon, near-black obsidian-like skin,
...
**Orc — 약 (Lv1)**
```
pixel art, small orc, stocky primitive build, dull gray-green skin, barely clothed in hides,
...
**Orc — 중 (Lv2)**
```
pixel art, orc berserker, muscular heavy build, dark gray-green skin,
...
**Orc — 강 (Lv3)**
```
pixel art, elite orc warlord, enormous brutish figure, deep dark green skin,
...
**Skeleton — 약 (Lv1)**
```
pixel art, small skeleton, thin rattling bones, yellowed old bone,
...
**Skeleton — 중 (Lv2)**
```
pixel art, skeleton warrior, complete bone frame, dark yellowed bones,
...
**Skeleton — 강 (Lv3)**
```
pixel art, elite skeleton knight, imposing armored skeleton, dark reinforced bone frame,
...
**Zombie — 약 (Lv1)**
```
pixel art, small zombie, hunched shambling corpse, pale gray-green decaying skin,
...
**Zombie — 중 (Lv2)**
```
pixel art, zombie brute, large bloated undead corpse, dark sickly green-gray skin,
...
**Zombie — 강 (Lv3)**
```
pixel art, elite zombie titan, enormous decayed undead mass, dark gray-green bloated body,
...
**Ghost — 약 (Lv1)**
```
pixel art, small ghost, translucent pale wisp, barely visible ethereal form,
...
**Ghost — 중 (Lv2)**
```
pixel art, ghost specter, floating ethereal figure, semi-transparent pale blue-white form,
...
**Ghost — 강 (Lv3)**
```
pixel art, elite ghost wraith, large powerful ethereal entity, deep blue-black translucent form,
...
**Vampire — 약 (Lv1)**
```
pixel art, lesser vampire, pale gaunt humanoid, sunken dark eyes, small fangs,
...
**Vampire — 중 (Lv2)**
```
pixel art, vampire hunter, elegant deadly figure, marble pale skin,
...
**Vampire — 강 (Lv3)**
```
pixel art, elite vampire lord, commanding aristocratic dark figure, flawlessly pale skin,
...
**Lich — 약 (Lv1)**
```
pixel art, lesser lich, skeletal robed figure, yellowed bones visible under tattered dark robes,
...
**Lich — 중 (Lv2)**
```
pixel art, lich sorcerer, skeletal undead mage, dark ornate robes with glowing runes,
...
**Lich — 강 (Lv3)**
```
pixel art, elite lich archmage, ancient impossibly powerful skeletal mage,
